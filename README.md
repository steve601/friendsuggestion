# SOCIAL MEDIA FRIEND SUGESTION

## Overview
->The purpose of this project is to suggest to a user a new person he/she may know based on his/her interest
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/friendsuggestion.git
    cd friendsuggestion
    ```
...
**Upload Application Code:**
    ...
    Place the code in a suitable directory, e.g., /home/ec2-user/friend-suggest.
...
#### Conclusion
Your Medicine Recommender System should now be deployed and accessible via your EC2 instance's public DNS or your configured domain name. Make sure to regularly update your system, monitor its performance, and secure it against potential threats.